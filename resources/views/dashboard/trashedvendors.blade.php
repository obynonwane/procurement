							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">LIST OF TRASHED VENDORS</h4>
											...
											<tbody>
											   ...
											   <tr>
                                                    ...
                                                    <div class="form-button-action">
															<a href="{{route('vendor.restore',['id'=>$vendor->id])}}" >
															<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Restore Vendor">
