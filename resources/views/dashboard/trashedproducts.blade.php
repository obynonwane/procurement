							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">LIST OF DELETED PRODUCTS	</h4>
											   ...
											   <tr>
													...
													<td>
														...
														@if(Auth::user()->role=='admin')
															...
															<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Restore Product">
